...
public class MultiLabel extends BaseOperator implements IOperator {
    private static Logger LOG = LoggerFactory.getLogger(MultiLabel.class);
    ...
    public MultiLabel(SqlTreeNode sqlTreeNode, String dbName) {
        super(sqlTreeNode);
        this.taskCategory = TaskCategory.TEXT;
        this.taskType = TaskType.MULTI_LABEL;
        this.DBNAME= dbName;
        setCrowd(true);
    }
