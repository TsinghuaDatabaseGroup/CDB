...
public class CrowdGTOperator extends BaseOperator implements IOperator {
    private static Logger LOG = LoggerFactory.getLogger(CrowdGTOperator.class);
    ...
    public CrowdGTOperator(SqlTreeNode sqlTreeNode,String dbName) {
        super(sqlTreeNode);
    ...
    public boolean process() {
        ...
        LOG.info("CrowdGT : "+sqlTreeNode.getWhereClause());
