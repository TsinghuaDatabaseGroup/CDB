...
public class LTOperator extends BaseOperator implements IOperator {
    private static Logger LOG = LoggerFactory.getLogger(LTOperator.class);
    ...
    public LTOperator(SqlTreeNode sqlTreeNode,String dbName) {
        super(sqlTreeNode);
