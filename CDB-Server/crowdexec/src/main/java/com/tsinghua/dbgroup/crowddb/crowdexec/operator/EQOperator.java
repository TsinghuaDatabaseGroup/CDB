...
public class EQOperator extends BaseOperator implements IOperator {
    private static Logger LOG = LoggerFactory.getLogger(EQOperator.class);
    ...
    public EQOperator(SqlTreeNode sqlTreeNode,String dbName) {
        super(sqlTreeNode);
